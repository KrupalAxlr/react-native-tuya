...
```
npm install @krupal/react-native-tuya
```
...
```js
import { loginWithEmail } from '@krupal/react-native-tuya';
...
```js
import { getRegisterEmailValidateCode, registerAccountWithEmail } from '@krupal/react-native-tuya';
...
```js
import { getCurrentUser } from '@krupal/react-native-tuya';
